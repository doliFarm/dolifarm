...
/**
 * \file    test/phpunit/DoliFarmFunctionalTest.php
 * \ingroup dolifarm
 ...
 *
 * @package Testdolifarm
 */
class DoliFarmFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/dolifarm/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolifarm/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolifarm/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolifarm/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolifarmwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliFarm_DoliFarmTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliFarm_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
